...
class paginator {
    ...
    static function view($count, $current, $class, $method = null, $search = null) {
            ...
            if ($current != 1) {
                echo "<li class='page-item'><a class='page-link' href='" . URL . $class ;
                if($method != null){
                    echo "/".$method;
                }
                echo "/1/" . $search . "'>"
            ...
            for ($i; $i < $b; $i++) {
                ...
                echo "'><a class='page-link' href='" . URL . $class . "/";

                if($method != null){
                    echo $method . "/";
                }
                echo $a . "/" . $search . "'>" . $a . "</a></li>";
            }
    ...
    static function view0($count, $current, $class, $method, $search = null) {
